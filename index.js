...
async function syncWithEcowitt(forceWrite = false) {
    ...
    try {
        ...
        state.cachedData = {
            ...
            wind: { speed: liveWind, gust: liveGust, maxS: mx_w, maxSTime: mx_w_t, deg: d.wind.wind_direction.value, card: getCard(d.wind.wind_direction.value) },
    ...
    <div class="container">
        ...
        <div class="grid-system">
            ...
            <div class="card">
                ...
                <div class="sub-pill">● Max Today: <span id="mw" style="margin-left:4px">--</span></div>
                <div class="sub-box-4">
                    <div class="badge"><span class="badge-label">Gust Speed</span><span id="wg" class="badge-val">--</span></div>
                    <div class="badge"><span class="badge-label">Daily Low</span><span id="mn" class="badge-val" style="color:var(--min-t)">--</span></div>
                </div>
            </div>
            <div class="card">
                <div class="label">Rain (24h)</div>
                <div class="main-val"><span id="r_tot">--</span><span class="unit">mm</span></div>
                <div style="display:flex; gap:8px;"><div class="sub-pill">● Rate: <span id="r_rate" style="margin-left:4px">--</span> mm/h</div><div class="sub-pill">● Max: <span id="mr" style="margin-left:4px">--</span></div></div>
                <div class="sub-box-4">
    ...
    <script>
        ...
        async function update() {
            try {
                ...
                document.getElementById('dp').innerText = d.temp.dew + '°';
                ...
                document.getElementById('r_week').innerText = d.rain.weekly + ' mm'; document.getElementById('r_year').innerText = d.rain.yearly + ' mm';
                ...
                if(!charts.cT) { 
                    charts.cT = setupChart('cT', 'Temperature (°C)', '#38bdf8'); charts.cH = setupChart('cH', 'Humidity (%)', '#10b981'); 
                    charts.cW = setupChart('cW', 'Wind Speed (km/h)', '#fbbf24'); charts.cR = setupChart('cR', 'Rain (mm)', '#818cf8'); 
                }
