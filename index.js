...
app.get("/weather", async (req, res) => {
    ...
    if (cachedData && (now - lastFetch < 60000)) {  // Cache for 60 seconds
...
<style>
body { margin:0; font-family:'Segoe UI',Arial,sans-serif; background:linear-gradient(135deg,#0f172a,#1e293b); color:#e2e8f0; min-height:100vh; font-size:14px; line-height:1.4; }
