...
<head>
    ...
    <style>
        ...
        .card { background: var(--card); padding: 22px; border-radius: 20px; border: 1px solid #1e293b; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.4); }
...
<body>
    ...
    <div class="readings-grid">
        ...
        <div class="card">
            ...
            <div class="sub-box">
                <div class="badge" style="color:#94a3b8">Dew: <span id="dp">--</span></div>
