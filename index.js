...
async function syncWithEcowitt(forceWrite = false) {
    ...
    try {
        ...
        // DB Write Logic (Every 2 Minutes)
    ...
    <script>
        ...
        async function update() {
            try {
                ...
                document.getElementById('sol').innerText = d.solar.rad + ' W/m²'; document.getElementById('uv').innerText = d.solar.uvi;
                ...
                if(!charts.cT) { 
                    ...
                    charts.cR = setupChart('cR', 'Rain (mm)', '#818cf8'); 
                }
